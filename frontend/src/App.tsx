...
function EdaPanel({ runId }: { runId: string }) {
...
function TimelinePanel({ runId, live }: { runId: string; live: boolean }) {
...
function ReportPanel({ runId, status }: { runId: string; status?: string | null }) {
