...
from agents.language import with_reply_language
...
def wrap_model(
    ...
    def create_system_message(state):
        ...
        # The retrieved documents are usually English; the reply still has to
        # follow the language the question was asked in.
        base_prompt = with_reply_language(base_prompt, state["messages"], config)
